...
(function($) {
    ...
    */
    ...
    /**
    - getTextInfo(layer, text, fonts, angle, width)
     ...
     Font is either a string of space-separated CSS classes or a fonts-spec object,
     defining the text's fonts and style.
    ...
    */
    ...
    /**
    - addText (layer, x, y, text, fonts, angle, width, halign, valign, transforms)
    ...
    */
    ...
    /**
    - removeText (layer, x, y, text, fonts, angle)
      ...
      Text is the string to remove, while the fonts is either a string of space-separated CSS
