...
///////////////Show Hide Box in Register Seminar Page/////////
function show1(){
    document.getElementById('address').style.display ='none';
    document.getElementById('online_box').style.display ='flex';

}
function show2(){
    document.getElementById('address').style.display = 'flex';
    document.getElementById('online_box').style.display ='none';
}
function show3(){
    document.getElementById('ejra_type_ostan').style.display = 'flex';
    document.getElementById('ejra_type_city').style.display = 'flex';
}
function show4(){
    document.getElementById('ejra_type_ostan').style.display = 'none';
    document.getElementById('ejra_type_city').style.display = 'none';
}
